...
- [AGENTS.md](AGENTS.md) — universal entry point (cursor.so, aider, etc.)
- [.github/copilot-instructions.md](.github/copilot-instructions.md) — GitHub Copilot

Both point at [docs/INDEX.md](docs/INDEX.md), which fans out to small
focused topic files so you only pay tokens for what you need.
